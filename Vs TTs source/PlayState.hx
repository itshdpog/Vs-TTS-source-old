...
//		case 401:
//remove(gellogus);
//dad = new Character(100, 100, 'mcwaterbottle');
//add(boyfriend);
	//	case 743:
//remove(mcwaterbottle);
//dad = new Character(100, 100, 'gripplesnatch');
//add(boyfriend);
// 	}
//}
		#if windows
		...
		{
			case 0:
				storyDifficultyText = "hes shit at the game";
			case 1:
		...
		DiscordClient.changePresence(detailsText + " " + SONG.song + " (" + storyDifficultyText + ") " + Ratings.GenerateLetterRank(accuracy), "\nAcc: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Score: " + songScore + " | Not Hit Notes: " + misses  , iconRPC);
		#end
		...
		switch (songLowercase)
		{
			...
			case 'shelf-for-life':
				dialogue = CoolUtil.coolTextFile(Paths.txt('shelf-for-life/funny'));
		}
